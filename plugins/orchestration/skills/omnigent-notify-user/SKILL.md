---
name: omnigent-notify-user
description: Send a progress notification to the user who triggered this Omnigent task (e.g., via Slack or Linear).
---
When you want to send a progress update to the user (for example, after completing a significant milestone), run:

```sh
"$OMNIGENT_CLI" harness-support notify-user --message '<message>'
```
